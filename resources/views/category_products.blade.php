...
@section('title')
Danh mục sản phẩm - Nhà sách Ánh Hoàng
@endsection
                        ...
                        <div class="category-products">
                            <div class="toolbar-top">
                                <div class="toolbar">
                                    <div class="sorter">
                                        @if(isset($title))
                                        <p class="view-mode" style="color : #00ab9f; font-weight : 500; border : 1px solid #00ab9f; margin-left : 20px;">
                                            {{$title}}
                                        </p>
                                        @endif
                                                ...
                                                <div class="product-shop">
                                                    <div class="f-fix">
                                                        ...
                                                        <div class="price-box">
                                                            ...
                                                            @endif
                                                            <p class="special-price">
                                                                <span class="price" content="60" id="product-price-182-emprice-e28d8be0787e9d8ae65c6afe74f8df0a" style="color: #00ab9f; padding-top:10px;">
                                                                    {{number_format($item->price_sale*1000 ,0 ,'.' ,'.')}} VND
                                                                </span>
                                                            </p>
                                                        </div>
