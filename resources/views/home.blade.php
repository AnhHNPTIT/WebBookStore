...
<div class="row">
            ...
            <div class="em-slideshow" style="padding-left: 20px;">
                <div class="em-owlcarousel-slideshow">
                    <div id="em_owlcarousel_2_2484_sync1" class="owl-carousel">
                        <!-- Banner 1 -->
                        <div class="item">
                            <img alt="BANNER 01" class="lazyOwl img-responsive" data-src="images/slides/slider1.png" />
                        </div>
                        <!-- Banner 2 -->
                        <div class="item">
                            <img alt="BANNER 02" class="lazyOwl img-responsive" data-src="images/slides/slider2.png" />
                        </div>
                        <!-- Banner 3 -->
                        <div class="item">
                            <img alt="BANNER 03" class="lazyOwl img-responsive" data-src="images/slides/slider3.png" />
                        </div>
    ...
    <div class="col-sm-6 col-sm-pull-18 em-col-left em-sidebar">
            ...
            <div class="menu-wrapper hidden-xs">
                ...
                <div class="menuleft">
                    <div id="menu-default" class="mega-menu em-menu-icon">
                            ...
                            <div class="em_nav" id="toogle_menu_5_4607">
                                <ul class="vnav em-menu-icon effect-menu em-menu-long">
                                    <li class="menu-item-link menu-item-depth-0 fa fa-dropbox menu-item-parent" style="width: 300px;">
                                        <a class="em-menu-link" href="{{ url('/cua-hang/bo-sung-vitamin-khoang-chat') }}"> <span style="text-transform: uppercase;"> Sách thiếu nhi </span> </a>
                        ...
                        <li class="menu-item-link menu-item-depth-0 fa fa-dropbox menu-item-parent" style="width: 300px;">
                            <a class="em-menu-link" href="{{ url('/cua-hang/nuoc-tang-luc-giai-khat') }}"> <span style="text-transform: uppercase;"> Sách chữ ký </span> </a>
                            <ul class="menu-container">
                                <li class="menu-item-hbox menu-item-depth-1 col-menu menu_col10  fix-top menu-item-parent" style="">
                                    <ul class="menu-container">
                                        <li class="menu-item-vbox menu-item-depth-2 col-sm-12 alpha menu-item-parent" style="">
                ...
                <li class="menu-item-link menu-item-depth-0 fa fa-dropbox menu-item-parent" style="width: 300px;">
                    <a class="em-menu-link" href="{{ url('/cua-hang/giau-chat-xo-tieu-hoa') }}"> <span style="text-transform: uppercase;"> Sách giới hạn </span> </a>
                    <ul class="menu-container">
                        <li class="menu-item-hbox menu-item-depth-1 col-menu menu_col10  fix-top menu-item-parent" style="">
                            <ul class="menu-container">
                                <li class="menu-item-vbox menu-item-depth-2 col-sm-12 alpha menu-item-parent" style="">
        ...
        <li class="menu-item-link menu-item-depth-0 fa fa-dropbox menu-item-parent" style="width: 300px;">
            <a class="em-menu-link" href="{{ url('/cua-hang/chuc-nang-dac-biet') }}"> <span style="text-transform: uppercase;"> Sách khác </span> </a>
            <ul class="menu-container">
                <li class="menu-item-hbox menu-item-depth-1 col-menu menu_col10  fix-top menu-item-parent" style="">
                    <ul class="menu-container">
                        <li class="menu-item-vbox menu-item-depth-2 col-sm-12 alpha menu-item-parent" style="">
                    ...
                    <div id="emtabs_1" class="em-tabs emtabs r-tabs">
                        <ul class="em-tabs-control tabs-control r-tabs-nav">
                            <li class="r-tabs-tab r-tabs-state-active">
                                <a class="r-tabs-anchor active" href="#tab_emtabs_1_1" style="text-transform: uppercase;"> <span class="icon"></span>Sách thiếu nhi</a>
                            </li>

                            <li class="r-tabs-state-default r-tabs-tab">
                                <a class="r-tabs-anchor" href="#tab_emtabs_1_2" style="text-transform: uppercase;"> <span class="icon"></span>Sách chữ ký</a>
                            </li>

                            <li class="r-tabs-state-default r-tabs-tab">
                                <a class="r-tabs-anchor" href="#tab_emtabs_1_3" style="text-transform: uppercase;"> <span class="icon"></span>Sách giới hạn</a>
                            </li>

                            <li class="r-tabs-state-default r-tabs-tab">
                                <a class="r-tabs-anchor" href="#tab_emtabs_1_4" style="text-transform: uppercase;"> <span class="icon"></span>Sách khác</a>
                            </li>
                        </ul>
                        ...
                        <div class="f-fix">
                            ...
                            <div class="price-box">
                                @if($item->price_sale < $item->price)
                                    ...
                                    <p class="special-price">
                                        <span class="price" content="60" style="color: #00ab9f;">
                                            {{number_format($item->price_sale*1000 ,0 ,'.' ,'.')}} VND
                                        </span>
                                    </p>
                            </div>
...
<div class="row">
    <h3 class="section-title section-title-center" style="text-align: center; text-transform: uppercase; color : #555;">
        <b></b>
        <span class="section-title-main">Kiến thức</span>
        <b></b>
    </h3>
    <div class="em-wrapper-banners">
        <div class=" slider-style02">
