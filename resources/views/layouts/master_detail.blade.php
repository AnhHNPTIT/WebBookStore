                                                        ...
                                                        <div class="em_nav" id="toogle_menu_7_5505">
                                                            <ul class="hnav em_menu_mobile">
                                                                ...
                                                                <li class="menu-item-link menu-item-depth-0 dd-menu-link fa fa-address-book-o">
                                                                    <a class="em-menu-link" href="{{ url('/kien-thuc') }}"> <span style="text-transform: uppercase;"> Sức khỏe cho bé</span> </a>
                                                                </li><!-- /.menu-item-link -->

                                                                <li class="menu-item-link menu-item-depth-0 dd-menu-link fa fa-medkit">
                                                                    <a class="em-menu-link" href="{{ url('/cua-hang/thuoc') }}"> <span style="text-transform: uppercase;"> Sách thiếu nhi </span> </a>
                                                                </li><!-- /.menu-item-link -->

                                                                <li class="menu-item-link menu-item-depth-0 dd-menu-link fa fa-dropbox">
                                                                    <a class="em-menu-link" href="{{ url('/cua-hang/thuc-pham-chuc-nang') }}"> <span style="text-transform: uppercase;"> Sách chữ ký </span> </a>
                                                                </li><!-- /.menu-item-link -->

                                                                <li class="menu-item-link menu-item-depth-0 dd-menu-link fa fa fa-shopping-cart">
                                                                    <a class="em-menu-link" href="{{ url('/cua-hang/hang-tieu-dung') }}"> <span style="text-transform: uppercase;"> Sách giới hạn </span> </a>
                                                                </li><!-- /.menu-item-link -->

                                                                <li class="menu-item-link menu-item-depth-0 dd-menu-link fa fa-ambulance">
                                                                    <a class="em-menu-link" href="{{ url('/cua-hang/thiet-bi-y-te') }}"> <span style="text-transform: uppercase;"> Sách khác </span> </a>
                                                                </li><!-- /.menu-item-link -->
                                                    ...
                                                    <div class="em_nav" id="toogle_menu_4_7164">
                                                        <ul class="hnav em_hoz_menu effect-menu">
                                                            ...
                                                            <li class="menu-item-link menu-item-depth-0 hidden-sm hidden-md menu-item-parent">
                                                                <a class="em-menu-link" href="{{ url('/kien-thuc') }}"> <span>Kiến thức</span> </a>
