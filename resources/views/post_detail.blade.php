                        ...
                        <div class="block em_block-recent-post em-line-01">
                            ...
                            <div class="block-content">
                                <ul class="em-recent-post">
                                    ...
                                    <li class="item">
                                        <a href="{{ url('/kien-thuc/'.$post->slug) }}">
                                            <img alt="{{ url('/kien-thuc/'.$post->slug) }}" src="{{asset('/images/'.$post->thumbnail)}}" />
                                        </a>
                                        <a class="post-title em-blog-title" href="{{ url('/kien-thuc/'.$post->slug) }}" style="text-transform: capitalize !important;">
                                            {{$post->title}}
                                        </a>
                                        <p class="intro">
                        ...
                        <div class="block em_block-tag-cloud em-line-01">
                            ...
                            <div class="block-content">
                                <ul>
                                    @if(isset($tags))
                                    @foreach($tags as $tag)
                                    <li class="item"><a href="{{ url('/tag/'.$tag->slug) }}" style="font-size:122px; color: #00ab9f;">{{$tag->name}}</a>
                                    </li>
                                    @endforeach
                                    @endif
                                </ul>
